...
<p><textarea id="content" class="publisher_textarea"></textarea></p><button type="button" id="post_post" class="btn btn-danger">{lag 发布}</button><span id="acom">@{$thread_data['id']}</span></div>
