...
<div class="amp-wp-article-content">
 {php $i=0;$pagetime=0;}
{if $data}{foreach $data as $v}<?php $i++;$pagetime=$v['btime'];?>{include f_list}
...
<div class="amp-wp-meta amp-wp-comments-link">{if $i>9}<a href="/f/{$fdata['id']}/{$mode}/{$pagetime}.html" class="btn btn-primary btn-lg btn-block">{lag 下一页}</a>{else}{lag 完毕}{/if}</div>
