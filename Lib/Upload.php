        ...
        foreach ($files as $key => $file) {
            ...
            if (!$this->check($file)){
                ...
                $file['sha1'] = sha1_file($file['tmp_name']);
				 $file['savename'] =  substr($file['md5'], 0, 3).'/'.$file['sha1'].'.'.$file['ext'];
		$file['spath']=substr($file['md5'], 0, 3).'/';
...
if(empty($imginfo)){$this->error = '非法图像文件！';continue;}else{$info['img']=$imginfo;}
 }
