...
</div><div class="wrap-box"><?php if ($i>9): ?><a href="/index/index/<?php echo $mode;?>/<?php echo $pagetime;?>.html" class="btn btn-primary btn-lg btn-block" id="getmore">下一页</a><?php else: ?><a class="btn btn-lg btn-block" id="getmore" href="/">首页</a><?php endif ?></div></div>
<div id="right-bar">
...
<div class="right-widget only-logo">
<div class="head">内容联盟<a href="https://cht.ysv8.com" class="pull-right js-tooltip">地球城</a></div>
