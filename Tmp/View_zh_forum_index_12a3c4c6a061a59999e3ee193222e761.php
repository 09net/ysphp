...
<div class="container">
 <div id="main">
<div class="widget-docs-search shadow"><div class="inner"><form method="get" action="/search" style="margin-bottom:0;position: relative;"><input name="name" value="<?php if (isset($q)): ?><?php echo $q;?><?php endif ?>" class="h-scanfin" type="text"><button class="icon-search h-scanf"></button></form></div></div>
...
<div class="col-xs-4"><a href="/f/<?php echo $v['id'];?>.html"><img  src="http://zh.test.com/upload/<?php echo $v['img'];?>" width="80" height="80" class="circle"><h2><?php echo $v['name'];?></h2></a>
 <p>主题:<?php echo $v['threads'];?>&nbsp;&nbsp;回复:<?php echo $v['posts'];?></p>
 </div>
<?php endforeach ?>
<?php endif ?>
</div>
...
<div class="wrap-box"><?php if ($i>9): ?><a href="/f/index/<?php echo $pagetime;?>.html" class="btn btn-primary btn-lg btn-block" id="getmore">下一页</a><?php else: ?><a class="btn btn-lg btn-block" id="getmore" href="/">首页</a><?php endif ?></div>
